...
// APIClient manages communication with the Ververica Platform API API v2.4.3
...
type APIClient struct {
	...
	JobGraphApi *JobGraphApiService

	NamespacesApi *NamespacesApiService

	SqlApi *SqlApiService

	UdfArtifactsApi *UdfArtifactsApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.JobGraphApi = (*JobGraphApiService)(&c.common)
	c.NamespacesApi = (*NamespacesApiService)(&c.common)
	c.SqlApi = (*SqlApiService)(&c.common)
	c.UdfArtifactsApi = (*UdfArtifactsApiService)(&c.common)
