...
func (r *VpNamespaceReconciler) updateResource(resource *v1beta1.VpNamespace, namespace *platformapiclient.Namespace) error {
	...
	var err error
	if resource.Status.LifecyclePhase, err = nativeconverters.NamespaceLifecyclePhaseToNative(namespace.LifecyclePhase); err != nil {
		return err
	}
...
func (r *VpNamespaceReconciler) handleDelete(req ctrl.Request) (ctrl.Result, error) {
	...
	lifecylePhase, err := nativeconverters.NamespaceLifecyclePhaseToNative(namespace.LifecyclePhase)
	if err != nil {
		return ctrl.Result{}, err
	}
